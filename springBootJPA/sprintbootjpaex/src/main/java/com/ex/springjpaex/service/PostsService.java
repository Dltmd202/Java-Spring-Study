package com.ex.springjpaex.service;

import com.ex.springjpaex.domain.posts.Posts;
import com.ex.springjpaex.domain.posts.PostsRepository;
import com.ex.springjpaex.web.dto.PostsListResponseDto;
import com.ex.springjpaex.web.dto.PostsResponseDto;
...
public class PostsService {
    ...
    public void delete(Long id){
        Posts posts = postsRepository.findById(id)
                .orElseThrow(() -> new
                        IllegalArgumentException("해당 게시글이 업습니다."));
